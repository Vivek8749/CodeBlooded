    ...
    <div className="min-h-screen w-full overflow-hidden relative flex flex-col">
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        <motion.div
          className={`absolute bottom-20 right-10 w-80 h-80 rounded-full blur-3xl ${
            isDark ? "bg-[#FF7F50]/10" : "bg-[#FF7F50]/40"
          }`}
          animate={{
            y: [0, -40, 0],
            x: [0, -30, 0],
        ...
        <motion.div
          className={`absolute top-1/2 left-1/2 w-96 h-96 rounded-full blur-3xl ${
            isDark ? "bg-[#1A1F1A]/50" : "bg-white/60"
          }`}
          animate={{
            scale: [1, 1.2, 1],
            rotate: [0, 90, 0],
        ...
        >
          ...
          <h1
            className={`text-6xl md:text-8xl mb-4 ${
              isDark ? "text-[#C5EFCB]" : "text-[#020402] drop-shadow-sm"
            }`}
          >
            RideN'Byte
          </h1>
          <p
            className={`text-xl md:text-2xl ${
              isDark ? "text-[#758173]" : "text-[#020402]/80"
            } max-w-2xl mx-auto`}
          >
        ...
        >
          {[
            ...
            <div key={index} className="text-center">
              <div
                className={`text-3xl md:text-4xl mb-1 bg-gradient-to-r ${
                  isDark
      ...
      <div
        ...
        className={`relative z-10 px-6 py-24 scroll-mt-24 ${
          isDark
            ? "bg-[#020402]"
            : "bg-gradient-to-b from-transparent to-[#A9C5A0]/30"
        }`}
      >
        <div className="max-w-7xl mx-auto">
          ...
          >
            <span
              className={`inline-block px-4 py-2 rounded-full backdrop-blur-md mb-6 ${
                isDark
                  ? "bg-[#FF7F50]/20 text-[#FF7F50]"
                  : "bg-[#FF7F50]/30 text-[#FF7F50]"
              }`}
            >
              The Problem
            </span>
            ...
            >
              Students Are{" "}
              <span className={isDark ? "text-[#FF7F50]" : "text-[#FF7F50]"}>
                OVERSPENDING
              </span>{" "}
            </h2>
            <p
            ...
            >
              Every day, students book separate rides and food orders to the
              same destinations and restaurants, leading to{" "}
              <span className={isDark ? "text-[#FF7F50]" : "text-[#FF7F50]"}>
                unnecessary costs
              </span>{" "}
              and
          ...
          >
            ...
            >
              RideN'Byte connects students to share rides and group food orders,
              making it easy to
              <span className={isDark ? "text-[#F4B400]" : "text-[#F4B400]"}>
                {" "}
                reduce costs
              </span>{" "}
              and
              ...
              while building a stronger campus community.
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                title: "Shared Rides",
                description:
                  "Find students going to the same destination and split the ride cost",
                color: isDark
                  ? "from-[#F4B400] to-[#FFD166]"
                  : "from-[#F4B400] to-[#FF7F50]",
              },
              {
                ...
                description:
                  "Coordinate orders from the same restaurant and share delivery fees",
                color: isDark
                  ? "from-[#FF7F50] to-[#FFD166]"
                  : "from-[#FF7F50] to-[#F4B400]",
              },
              {
                icon: MessageSquare,
                title: "Group Chat",
                description:
                  "Real-time messaging to coordinate with your group members",
                color: isDark
                  ? "from-[#C5EFCB] to-[#758173]"
                  : "from-[#A9C5A0] to-[#C6DEC6]",
              },
              {
                icon: DollarSign,
                title: "Smart Payment Splitting",
                description:
                  "Automatically calculate and split costs fairly among all participants",
                color: isDark
                  ? "from-[#F4B400] to-[#C5EFCB]"
                  : "from-[#F4B400] to-[#A9C5A0]",
              },
              {
                icon: MapPin,
                title: "Live Tracking",
                description:
                  "Track your ride or delivery in real-time on an interactive map",
                color: isDark
                  ? "from-[#FF7F50] to-[#F4B400]"
                  : "from-[#FF7F50] to-[#FFD166]",
              },
              {
                ...
                description:
                  "Connect only with verified students for a safe and trusted experience",
                color: isDark
                  ? "from-[#758173] to-[#C5EFCB]"
                  : "from-[#758173] to-[#C6DEC6]",
              },
            ].map((feature, index) => (
              <motion.div
                key={index}
              ...
              {[
                {
                  ...
                  title: "Search",
                  description:
                    "Find rides or food orders going to your destination",
                },
                {
                  step: "2",
                  title: "Join",
                ...
                },
                {
                  ...
                  title: "Save",
                  description:
                    "Split costs automatically and track your savings",
                },
              ].map((item, index) => (
                <motion.div
                  key={index}
              ...
              {[
                {
                  ...
                  title: "Save Up to 50%",
                  description:
                    "Cut your transportation and food delivery costs in half",
                  stat: "50%",
                },
                {
                  icon: Clock,
                  title: "Save Time",
                  description:
                    "Quick and easy coordination with built-in chat and tracking",
                  stat: "10min",
                },
                {
                  icon: Users,
                  ...
                  description:
                    "Meet fellow students and make new friends on campus",
                  stat: "500+",
                },
              ].map((benefit, index) => (
                <motion.div
          ...
          >
            ...
            >
              The talented individuals behind RideN'Byte, dedicated to making
              student life easier and more affordable
            </p>
              ...
              {[
                {
                  ...
                  color: isDark
                    ...
                    : "from-[#F4B400] to-[#FF7F50]",
                  linkedin:
                    "https://www.linkedin.com/in/vivek-kumar-maurya-b52261314",
                  github: "https://github.com/Vivek8749",
                ...
                },
                {
                  ...
                  color: isDark
                    ? "from-[#FF7F50] to-[#FFD166]"
                    : "from-[#FF7F50] to-[#F4B400]",
                  linkedin: "https://www.linkedin.com/in/adarsh-raj-7508a7345",
                  github: "https://github.com/Adarsh10-coder",
                ...
                },
                {
                  ...
                  color: isDark
                    ? "from-[#C5EFCB] to-[#758173]"
                    : "from-[#A9C5A0] to-[#C6DEC6]",
                  linkedin: "https://www.linkedin.com/in/aryan-kumar-2b2bba326",
                  github: "https://github.com/Aryan2024ee",
                ...
                },
                {
                  ...
                  color: isDark
                    ? "from-[#F4B400] to-[#C5EFCB]"
                    : "from-[#F4B400] to-[#A9C5A0]",
                  linkedin: "https://www.linkedin.com/in/raj-shreya38",
                  github: "https://github.com/TheCodeBlush",
                ...
                >
                  ...
                  {/* Icon Badge */}
                  <div
                    className={`w-16 h-16 rounded-2xl bg-gradient-to-br ${member.color} flex items-center justify-center mb-6 shadow-lg relative z-10`}
                  >
