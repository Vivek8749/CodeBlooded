						...
						{[
							{
								...
								title: "Shared Rides",
								description:
									"Find or create rides to the same destination",
								delay: 0.3,
							},
							{
								...
								title: "Food Orders",
								description:
									"Split delivery costs with fellow students",
								delay: 0.4,
							},
							{
								icon: Users,
								title: "Live Chat",
								description:
									"Stay connected with group messaging",
								delay: 0.5,
							},
						].map((feature, index) => (
							<motion.div
				...
				>
					<div className="max-w-7xl mx-auto">
						...
						>
							...
							>
								Every day, students book separate rides and food
								orders to the same destinations and restaurants,
								leading to{" "}
								<span
									className={
										isDark
						...
						>
							...
							>
								RideN'Byte connects students to share rides and
								group food orders, making it easy to
								<span
									className={
										isDark
											? "text-[#F4B400]"
							...
							<div className="grid grid-cols-1 md:grid-cols-4 gap-8">
								{[
									...
									},
									{
										...
										title: "Connect",
										description:
											"Chat with group members and coordinate details",
									},
									{
										step: "4",
										title: "Save",
						...
						>
							...
							>
								The talented individuals behind RideN'Byte,
								dedicated to making student life easier and more
								affordable
							</p>
								...
								{[
									...
									},
									{
										...
										color: isDark
											...
											: "from-[#FF7F50] to-[#F4B400]",
										linkedin:
											"https://www.linkedin.com/in/adarsh-raj-7508a7345",
									...
									},
									{
										...
										color: isDark
											...
											: "from-[#A9C5A0] to-[#C6DEC6]",
										linkedin:
											"https://www.linkedin.com/in/aryan-kumar-2b2bba326",
									...
									},
									{
										...
										color: isDark
											...
											: "from-[#F4B400] to-[#A9C5A0]",
										linkedin:
											"https://www.linkedin.com/in/raj-shreya38",
