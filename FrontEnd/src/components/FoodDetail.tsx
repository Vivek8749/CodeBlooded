...
export function FoodDetail({
  ...
  const [messages, setMessages] = useState([
    {
      id: 1,
      sender: "Sarah",
      text: "Hi everyone! I'm organizing this order from Pizza Palace.",
      time: "11:30 AM",
      isOwn: false,
    },
    {
      id: 2,
      sender: "You",
      text: "Awesome! What time is the delivery?",
      time: "11:32 AM",
      isOwn: true,
    },
    {
      id: 3,
      sender: "Sarah",
      text: "We're ordering at 6:00 PM, delivery should arrive by 6:30 PM.",
      time: "11:33 AM",
      isOwn: false,
    },
    {
      id: 4,
      sender: "Mike",
      text: "Perfect timing! Can't wait!",
      time: "11:35 AM",
      isOwn: false,
    },
  ]);
  ...
  const [deliveryStage, setDeliveryStage] = useState<
    "preparing" | "ready" | "picked-up" | "delivering"
  >("preparing");
            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`p-2 rounded-xl bg-gradient-to-br from-[#F4B400] to-[#FFD166]`}
                  >
              ...
              >
                ...
                <div className="relative h-full min-h-[350px] overflow-hidden">
                  ...
                  <div className="absolute inset-0">
                    ...
                    >
                      ...
                      <rect
                        width="400"
                        height="400"
                        fill="url(#food-grid-pattern)"
                      />
                      <rect
                        width="400"
                        height="400"
                        fill="url(#food-major-grid)"
                      />
                    </svg>
                    ...
                    <div className="absolute inset-0 pointer-events-none">
                      <div
                        className={`absolute left-6 top-1/2 text-xs px-2 py-1 rounded ${
                          isDark
                      ...
                      <div
                        className={`absolute right-12 top-1/3 text-xs px-2 py-1 rounded ${
                          isDark
                            ? "bg-[#020402]/60 text-[#758173]"
                            : "bg-white/60 text-[#020402]/70"
                        }`}
                  ...
                  <div className="relative h-full">
                    <svg
                      className="w-full h-full absolute inset-0 px-4 py-4"
                      viewBox="0 0 400 350"
                    ...
                    >
                      ...
                      <motion.g
                        initial={{ scale: 0 }}
                        animate={{
                          scale: deliveryStage !== "preparing" ? 1 : 0.5,
                        }}
                      ...
                      >
                        ...
                        <motion.g
                          ...
                          transition={{
                            duration: 0.5,
                            repeat:
                              deliveryStage === "delivering" ? Infinity : 0,
                          }}
                        >
                          <Bike
                            className="w-5 h-5"
