            ...
            >
              ...
              >
                <div className="flex items-center gap-3">
                  <div
                    className={`p-2 rounded-xl bg-gradient-to-br from-[#FF7F50] to-[#FFD166]`}
                  >
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-3">
                      ...
                      <div className="flex-1">
                        ...
                        >
                          {rideDetails.currentPassengers}/
                          {rideDetails.maxPassengers}
                        </p>
                      </div>
                    </div>
                    <div className="flex items-start gap-3">
