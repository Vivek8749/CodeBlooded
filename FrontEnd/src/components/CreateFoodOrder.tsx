...
export function CreateFoodOrder({ isDark, toggleTheme, onNavigateBack, onNavigateToDashboard, onNavigateToRideSearch, onNavigateToFoodSearch }: CreateFoodOrderProps) {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      setError(err.response?.data?.message || "Failed to create food order. Please try again.");
    } finally {
      setLoading(false);
    }
  };
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className={`p-4 rounded-xl space-y-4 ${
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-2">
                      <Label htmlFor="min-spent" className={`text-xs ${isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}`}>
                    ...
                    <div className="space-y-2">
                      ...
                      <Select value={offerType} onValueChange={(value: "percentage" | "flat") => setOfferType(value)}>
                        <SelectTrigger className={`${
                          isDark 
                            ? 'bg-[#020402]/40 border-[#3A463A] text-[#C5EFCB]' 
                            : 'bg-white/50 border-white/60 text-[#020402]'
                        ...
                        <SelectContent className={isDark ? 'bg-[#1A1F1A] border-[#3A463A]' : 'bg-white border-gray-200'}>
                          <SelectItem value="percentage" className={isDark ? 'text-[#C5EFCB] focus:bg-[#3A463A] focus:text-[#C5EFCB]' : 'text-[#020402]'}>
                            Percentage (%)
                          </SelectItem>
                          <SelectItem value="flat" className={isDark ? 'text-[#C5EFCB] focus:bg-[#3A463A] focus:text-[#C5EFCB]' : 'text-[#020402]'}>
                            Flat Amount (₹)
                          </SelectItem>
                        </SelectContent>
                      </Select>
                  ...
                  <div className="space-y-2">
                    <Label htmlFor="offer-amount" className={`text-xs ${isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}`}>
                    ...
                    <Input
                      ...
                      placeholder={offerType === "percentage" ? "e.g., 10" : "e.g., 500"}
                      value={offerAmount || ""}
                  ...
                  <div className={`text-xs ${isDark ? 'text-[#758173]' : 'text-[#020402]/70'} pt-2 border-t border-current/20`}>
                    💡 Example: Min spend ₹1000 with 10% off = ₹100 discount when target is reached
                  </div>
                </div>
                ...
                {/* Max Participants */}
                <div className="space-y-2">
                  <Label htmlFor="max-participants" className={isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}>
                    <div className="flex items-center gap-2">
                ...
                {/* Notes */}
                <div className="space-y-2">
                  <Label htmlFor="notes" className={isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}>
                    <div className="flex items-center gap-2">
                      ...
                      >
                        ...
                        <div className="space-y-1">
                          ...
                          {restaurant ? (
                            <Select 
                              value={item.name} 
                              onValueChange={(value: string) => updateItemFromMenu(item.id, value)}
                              required
                            >
                              <SelectTrigger className={`${
                                isDark 
                ...
                {success && (
                  ...
                  >
                    ...
                    <p className="text-sm">Food order created successfully! Redirecting...</p>
                  </motion.div>
                )}
