...
export function Footer({ isDark, onNavigate }: FooterProps) {
	...
	return (
		<footer
			className={`relative mt-auto px-6 py-12 ${
				isDark
					? "bg-[#020402]"
					: "bg-gradient-to-b from-transparent to-[#A9C5A0]/20"
			}`}
		>
			<div className="max-w-7xl mx-auto">
				...
				>
					...
					<div className="relative z-10">
						...
						<div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-8 mb-12">
							...
							<div className="lg:col-span-2">
								...
								>
									...
									>
										Connect with fellow students to share
										rides and food orders. Save money,
						...
						<div
							className={`h-px ${
								isDark ? "bg-[#3A463A]/50" : "bg-[#A9C5A0]/30"
							} mb-8`}
						/>
						...
						<div className="flex flex-col md:flex-row items-center justify-between gap-6">
							...
							>
								© {currentYear} RideN'Byte. Made with{" "}
								<Heart className="w-4 h-4 text-[#FF7F50] fill-[#FF7F50]" />{" "}
								for students
							</motion.p>
