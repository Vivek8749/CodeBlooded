...
const vehicleTypes = [
  ...
  { value: "auto", label: "Auto Rickshaw", icon: "🛺", pricePerKm: 5, capacity: 3 },
  { value: "car-sedan", label: "Car (Sedan)", icon: "🚗", pricePerKm: 8, capacity: 4 },
  { value: "car-suv", label: "Car (SUV)", icon: "🚙", pricePerKm: 10, capacity: 6 },
  { value: "van", label: "Van", icon: "🚐", pricePerKm: 12, capacity: 8 },
];

export function CreateRide({ isDark, toggleTheme, onNavigateBack, onNavigateToDashboard, onNavigateToRideSearch, onNavigateToFoodSearch }: CreateRideProps) {
  ...
  // Simulate map animation
  useEffect(() => {
    const interval = setInterval(() => {
      setMapProgress((prev) => (prev >= 100 ? 0 : prev + 0.5));
    }, 100);
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="space-y-6">
                ...
                <div className="space-y-2">
                  <Label htmlFor="origin" className={isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}>
                ...
                {/* Destination */}
                <div className="space-y-2">
                  <Label htmlFor="destination" className={isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}>
                    <div className="flex items-center gap-2">
                ...
                {/* Vehicle Type */}
                <div className="space-y-2">
                  <Label htmlFor="vehicle" className={isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'}>
                    <div className="flex items-center gap-2">
                        ...
                        >
                          <div className="flex items-center gap-2">
                            ...
                            <span className={`text-xs ${isDark ? 'text-[#758173]' : 'text-[#020402]/60'}`}>
                              (${vehicle.pricePerKm}/km, {vehicle.capacity} seats)
                            </span>
                          </div>
                        </SelectItem>
                      ))}
                ...
                {distance > 0 && (
                  ...
                  >
                    <div className="flex items-center justify-between">
                      ...
                      <span className={`text-lg ${isDark ? 'text-[#F4B400]' : 'text-[#FF7F50]'}`}>
                        {distance} km
                      </span>
                    </div>
                    ...
                    {selectedVehicleData && estimatedPrice > 0 && (
                      <div className={`text-sm ${isDark ? 'text-[#758173]' : 'text-[#020402]/70'} pt-2`}>
                        💡 Split between {selectedVehicleData.capacity} passengers = ${(estimatedPrice / selectedVehicleData.capacity).toFixed(2)} per person
                      </div>
                    )}
                  </motion.div>
                )}
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className={`text-sm ${isDark ? 'text-[#758173]' : 'text-[#020402]/70'}`}>
                      {origin && destination ? `${origin} → ${destination}` : 'Enter locations to see route'}
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="relative h-[600px] overflow-hidden">
                ...
                <div className="absolute inset-0">
                  ...
                  <svg className="w-full h-full absolute inset-0 opacity-30" viewBox="0 0 400 400">
                    <defs>
                      ...
                      <pattern id="major-grid-create" width="80" height="80" patternUnits="userSpaceOnUse">
                        <path 
                          d="M 80 0 L 0 0 0 80" 
                          fill="none" 
                          stroke={isDark ? '#C5EFCB' : '#020402'} 
                    ...
                    <rect width="400" height="400" fill="url(#major-grid-create)" />
                  </svg>
                ...
                {origin && destination ? (
                  <div className="relative h-full">
                    <svg className="w-full h-full absolute inset-0" viewBox="0 0 400 600" preserveAspectRatio="xMidYMid meet">
                      ...
                      {/* Origin Marker */}
                      <motion.g>
                        <circle cx="60" cy="480" r="20" fill={isDark ? '#F4B400' : '#FF7F50'} opacity="0.3"/>
                        <circle cx="60" cy="480" r="14" fill={isDark ? '#F4B400' : '#FF7F50'} />
                        <motion.circle
                          cx="60"
                          cy="480"
                          r="14"
                          ...
                          transition={{ duration: 2, repeat: Infinity }}
                        />
                        <text x="60" y="487" textAnchor="middle" fontSize="18" fill="white">📍</text>
                      </motion.g>

                      {/* Destination Marker */}
                      <motion.g>
                        <circle cx="340" cy="140" r="20" fill={isDark ? '#FF7F50' : '#F4B400'} opacity="0.3"/>
                        <circle cx="340" cy="140" r="14" fill={isDark ? '#FF7F50' : '#F4B400'} />
                        <motion.circle
                          cx="340"
                          cy="140"
                          r="14"
                        ...
                        />
                        <text x="340" y="147" textAnchor="middle" fontSize="18" fill="white">🎯</text>
                      </motion.g>
                    ...
                    <div className="absolute bottom-6 left-6 right-6 flex justify-between z-20">
                      ...
                      >
                        ...
                        <p className={`text-sm ${isDark ? 'text-[#C5EFCB]' : 'text-[#020402]'} truncate`}>
                          {origin}
                        </p>
                      </motion.div>
                      <motion.div 
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <div className="text-center">
                      <motion.div
                        ...
                        transition={{ duration: 2, repeat: Infinity }}
                      >
                        <MapPin className={`w-16 h-16 mx-auto mb-4 ${isDark ? 'text-[#758173]' : 'text-[#020402]/40'}`} />
                      </motion.div>
                      <p className={`text-lg ${isDark ? 'text-[#758173]' : 'text-[#020402]/70'}`}>
                        Enter origin and destination
                      </p>
                      <p className={`text-sm ${isDark ? 'text-[#758173]' : 'text-[#020402]/50'}`}>
